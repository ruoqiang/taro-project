...
export default class forgetPassword extends Component{
    ...
    login() {
        ...
        HTTP.post('Login/UserRegister', params).then(()=> {
            // 成功后
            ...
            <View>
                ...
                <View className='inputBox padType'>
                    <View className='input'>
                        ...
                        <Input className='inputt' placeholder='请输入密码'  type='number' value={this.state.code}  onChange={this.handlCodeChange.bind(this)} /> <View className={'send-smg-code ' + (this.codeBtnDisable ? 'disable' : '')}  onClick={this.getCode.bind(this,this.state.mobile)}>{this.state.codeBtnText}</View>
                    </View>
                </View>
                <View className='inputBox padType'>
                    <View className='input'>
                ...
                <View className='buttonBox '>
                        <View className='button reverse' onClick={this.goToPage.bind(this)}>
                        已有账号，去登录
                        </View>
                </View> 
            </View>
